<template>
  <div class="flex h-full">
    <!-- 一级菜单常驻侧边栏 -->
    <div
      class="relative h-full text-slate-700 dark:text-slate-300 border-r shadow dark:shadow-gray-700"
      :style="{
        width: config.layout_side_collapsed_width + 'px',
        backgroundColor: '#CA898F'
      }"
    >
      <el-scrollbar>
        <el-menu
    ...
    <!-- 二级菜单并列显示 -->
    <div
      class="relative h-full text-slate-700 dark:text-slate-300 border-r shadow dark:shadow-gray-700 px-2"
      :style="{
