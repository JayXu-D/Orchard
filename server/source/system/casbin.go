...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/album/create", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/album/list", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/album/delete", V2: "DELETE"},
		...
		{Ptype: "p", V0: "888", V1: "/drawing/update", V2: "PUT"},
		...
		{Ptype: "p", V0: "888", V1: "/drawing/recordDownload", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/drawing/downloadStatus", V2: "POST"},
		...
		{Ptype: "p", V0: "8881", V1: "/album/create", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/album/list", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/album/delete", V2: "DELETE"},
		...
		// 相册权限 - 角色9528（测试角色）
		{Ptype: "p", V0: "9528", V1: "/album/create", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/album/list", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/album/delete", V2: "DELETE"},
		...
		{Ptype: "p", V0: "9528", V1: "/drawing/update", V2: "PUT"},
		...
		{Ptype: "p", V0: "9528", V1: "/drawing/recordDownload", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/drawing/downloadStatus", V2: "POST"},
