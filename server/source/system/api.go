...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "相册", Method: "POST", Path: "/album/create", Description: "创建相册"},
		{ApiGroup: "相册", Method: "POST", Path: "/album/list", Description: "获取相册列表"},
		{ApiGroup: "相册", Method: "DELETE", Path: "/album/delete", Description: "删除相册"},
		{ApiGroup: "相册", Method: "PUT", Path: "/album/update", Description: "更新相册"},
		{ApiGroup: "相册", Method: "GET", Path: "/album/creator/:creatorUUID", Description: "根据创建者UUID获取相册列表"},
		{ApiGroup: "相册", Method: "GET", Path: "/album/admin/:adminID", Description: "根据管理员ID获取相册列表"},
		{ApiGroup: "相册", Method: "GET", Path: "/album/get", Description: "根据ID获取相册"},
	}
