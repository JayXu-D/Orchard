...
func (i *initAuthority) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysAuthority{
		{AuthorityId: 888, AuthorityName: "超级管理员", ParentId: utils.Pointer[uint](0), DefaultRouter: "home"},
		{AuthorityId: 9528, AuthorityName: "普通用户", ParentId: utils.Pointer[uint](0), DefaultRouter: "home"},
		{AuthorityId: 8881, AuthorityName: "管理员", ParentId: utils.Pointer[uint](888), DefaultRouter: "home"},
	}
